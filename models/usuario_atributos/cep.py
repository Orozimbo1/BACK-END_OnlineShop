...
class CepUsuarioModel(Base):
    ...
    def __init__(self, usuario_id, ponto_referencia, CEP, UF, cidade, bairro, rua, numero):
    ...
    def atualizar_endereco(self, usuario_id, ponto_referencia, CEP, UF, cidade, bairro, rua, numero):
        self.usuario_id: usuario_id
        self.ponto_referencia = ponto_referencia
        self.CEP = CEP
        self.UF = UF
